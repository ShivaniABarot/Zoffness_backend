    ...
    public function register(Request $request)
{
    ...
    try {
        ...
        $user = User::create([
            ...
            'password' => $validated['password'], // No need to hash here, the model will do it
        ]);
        ...
        try {
            ...
            $message = 'Account created successfully. (Email failed to send)';
        }
...
// ✅ Define this method outside of the register method
