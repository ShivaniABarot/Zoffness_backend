                    ...
                    <tbody>
                        @forelse($praticetests as $praticetest)
                            <tr>
                                ...
                                <td>{{ ($praticetest->parent_first_name ?? 'N/A') . ' ' . ($praticetest->parent_last_name ?? '') }}
                                </td>
                                <td><a
                                        href="tel:{{ $praticetest->parent_phone ?? '#' }}">{{ $praticetest->parent_phone ?? 'N/A' }}</a>
                                </td>
                                <td><a
                                        href="mailto:{{ $praticetest->parent_email ?? '#' }}">{{ $praticetest->parent_email ?? 'N/A' }}</a>
                                </td>
                                <td>{{ ($praticetest->student_first_name ?? 'N/A') . ' ' . ($praticetest->student_last_name ?? '') }}
                                </td>
                                <td><a
                                        href="mailto:{{ $praticetest->student_email }}">{{ $praticetest->student_email ?? 'N/A' }}</a>
                                </td>
                                <td>${{ number_format($praticetest->subtotal ?? 0, 2) }}</td>
                            </tr>
                        @empty
                            <tr>
                                <td></td>
