...
@section('content')
    <div class="container">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                @forelse($praticetests as $praticetest) <tr>
                        <td>{{ $loop->iteration }}</td>
                        <td>{{ $praticetest->parent_first_name . ' ' . $praticetest->parent_last_name }}</td>
                        <td><a href="tel:{{ $praticetest->parent_phone }}"
                                class="text-decoration-none">{{ $praticetest->parent_phone }}</a></td>
                        <td><a href="mailto:{{ $praticetest->parent_email }}"
                                class="text-decoration-none">{{ $praticetest->parent_email }}</a></td>
                        ...
                        <td>
                            @if($praticetest->student_email)
                                <a href="mailto:{{ $praticetest->student_email }}"
                                    class="text-decoration-none">{{ $praticetest->student_email }}</a>
                            @else
                                N/A
                            @endif
                        </td>
    ...
    @endforelse
                        ...
                        <td>
                            ...
                            <a href="#" class="btn btn-danger btn-sm" title="Delete"
                                onclick="deleteEnroll({{ $enrollment->id }})">
