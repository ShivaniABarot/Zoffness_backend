            ...
            <tbody>
                @forelse($sat_act_course as $course)
                    <tr>
                        ...
                        <td><a href="tel:{{ $course->parent_phone }}"
                                class="text-decoration-none">{{ $course->parent_phone }}</a></td>
                        <td><a href="mailto:{{ $course->parent_email }}"
                                class="text-decoration-none">{{ $course->parent_email }}</a></td>
                        <td>{{ $course->student_firstname . ' ' . $course->student_lastname }}</td>
                        <td>
                            @if($course->student_email)
                                <a href="mailto:{{ $course->student_email }}"
                                    class="text-decoration-none">{{ $course->student_email }}</a>
                            @else
                                N/A
                            @endif
                        </td>
