...
@section('content')
    <div class="container">
        ...
        <a href="{{ route('packages.create') }}" class="btn btn-primary mb-3">Add Timeslot</a>
            ...
            <tbody>
                @forelse($packages as $package)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('packages.show', $package->id) }}" class="btn btn-info btn-sm" title="View">
      ...
      function deletePackage(PID) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                jQuery.ajax({
                    url: '{{ route('packages.delete', '') }}/' + PID, // Construct URL dynamically
                    type: 'DELETE',
                    data: {
