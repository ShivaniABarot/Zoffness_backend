@extends('layouts.app')
@section('title', 'Add Our Approach')

@section('content')
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h2><i class="bi bi-plus-circle"></i> Add Our Approach</h2>
        
    </div>

    <div class="card shadow-sm p-4">
        <form action="{{ route('our-approach.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-3">
                ...
                <input type="text" name="section_title" id="section_title" class="form-control" 
                       value="{{ old('section_title') }}" required>
                @error('section_title') 
