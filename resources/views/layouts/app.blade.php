  ...
  <div class="layout-wrapper layout-content-navbar">
    ...
    <div class="layout-container">
      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme"
        style="width: 260px !important; position: fixed !important; top: 0 !important; bottom: 0 !important; left: 0 !important; z-index: 1000 !important; overflow-y: auto !important; background-color: #fff !important; box-shadow: 0 0.125rem 0.375rem 0 rgba(161, 172, 184, 0.12) !important; display: block !important; visibility: visible !important; transform: none !important; opacity: 1 !important;">
        ...
        <ul class="menu-inner py-1">
          ...
          <li class="menu-item {{ request()->is('dashboard') ? 'active' : '' }}">
            ...
            <a href="{{ route('dashboard') }}" class="menu-link"
              style="display: flex !important; align-items: center !important; padding: 0.6rem 1rem !important; width: calc(100% - 16px) !important; position: relative !important; left: 0 !important; z-index: 1 !important; visibility: visible !important; opacity: 1 !important;">

              <i class="menu-icon bx bx-home-circle"
                style="display: flex !important; align-items: center !important; justify-content: center !important; width: 20px !important; height: 20px !important; margin-right: 12px !important; flex-shrink: 0 !important; position: relative !important; left: 0 !important; visibility: visible !important; opacity: 1 !important;"></i>

              <div
                style="display: block !important; visibility: visible !important; white-space: nowrap !important; overflow: hidden !important; text-overflow: ellipsis !important; opacity: 1 !important; position: static !important; width: auto !important; height: auto !important; transform: none !important; margin-left: 0 !important;">
                Dashboard</div>
  ...
  <a href="{{ url('collage_essays_packages') }}" class="menu-link">
    ...
    <div>Essays Packages</div>
      ...
      <div class="layout-page"
        style="margin-left: 260px !important; width: calc(100% - 260px) !important; position: relative !important; display: block !important;">

        <!-- Header with Profile -->

        <div class="d-flex justify-content-end align-items-center px-4 pt-1 pb-0"
          style="background: transparent; box-shadow: none; margin: 0;">
          ...
          <div class="d-flex align-items-center">
            ...
            <div class="dropdown">
              ...
              <a class="dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown"
                ...
                <div class="avatar"
                  style="position: relative; width: 40px; height: 40px; background-color: #696cff; border-radius: 50%; display: flex; align-items: center; justify-content: center; border: 2px solid #fff; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">

                  <i class="bx bx-user-circle" style="color: white; font-size: 24px;"></i>

                  <span
                    style="position: absolute; bottom: 0; right: 0; width: 10px; height: 10px; background-color: #71DD37; border-radius: 50%; border: 2px solid #fff; box-shadow: 0 2px 5px rgba(0,0,0,0.1);"></span>
