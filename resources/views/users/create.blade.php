                        ...
                        <form id="createUserForm" enctype="multipart/form-data">
                                ...
                                <div class="form-floating">
                                    ...
                                    <label for="email">
                                        ...
                                        <i class="bi bi-question-circle ms-1" data-bs-toggle="tooltip"
                                            title="We'll never share your email."></i>
                                    </label>
                                </div>
                            ...
                            <div class="mb-3 position-relative">
                                <div class="form-floating">
                                    ...
                                    <label for="password_confirmation"><i class="bi bi-lock-fill me-2"></i>Confirm
                                        Password</label>
                                </div>
                                <i class="bi bi-eye-slash position-absolute top-50 end-0 translate-middle-y me-3 cursor-pointer"
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#createUserForm').on('submit', function (e) {
                ...
                if (!confirmPassword) { $('#passwordConfirmationError').text('Confirm Password is required'); valid = false; }
