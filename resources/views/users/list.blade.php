            ...
            @foreach ($users as $user)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="#" class="btn btn-danger btn-sm" title="Delete" onclick="deleteUser({{ $user->id }})">
                            <i class="fas fa-trash"></i>
                        </a>
                        
                    </td>
                    {{-- <td>
                        <a href="{{ route('users.show', $tutor->id) }}" class="btn btn-info btn-sm" title="View">
                            <i class="fas fa-eye"></i>
                        </a>
  ...
  function deleteUser(userID) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            jQuery.ajax({
                url: '{{ route('users.delete', '') }}/' + userID, // Construct URL dynamically
                type: 'DELETE',
                data: {
