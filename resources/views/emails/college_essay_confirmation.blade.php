    ...
    <div class="email-container">
        ...
        <p>
            @if($recipientType === 'admin')
                ...
                A new student has registered for college essay services. Below are the registration details:
            @else
                Dear {{ $recipientName }},<br><br>
                Thank you for registering for college essay services with Zoffness College Prep. Below are your registration details:
            @endif
        </p>
