...
<head>
  ...
  <title>Reset Password - Zoffness</title>
  ...
  <!-- Core CSS -->
  <link rel="stylesheet" href="{{ asset('css/reset-password-styles.css') }}" />
      ...
      <div class="authentication-inner py-4">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <p class="mb-4 text-center">Enter your new password to complete the reset process</p>
            ...
            <form method="POST" action="{{ route('password.update') }}" class="mb-3">
              ...
              <div class="mb-3">
                ...
                <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" placeholder="Enter your email" value="{{ $email ?? old('email') }}" required autofocus />
                @error('email')
              ...
              <div class="mb-3">
                ...
                <div class="input-group">
                  ...
                  <span class="password-toggle-icon" id="togglePasswordConfirmation"><i class="fa fa-eye-slash"></i></span>
                </div>
