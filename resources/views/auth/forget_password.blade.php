...
<head>
  ...
  <title>Forgot Password - Zoffness</title>
  ...
  <!-- Core CSS -->
  <link rel="stylesheet" href="{{ asset('css/forgot-password-styles.css') }}" />
      ...
      <div class="authentication-inner py-4">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <form id="forgot-password-form" class="mb-3">
              @csrf
              <div class="mb-3">
                ...
                <div class="text-danger mt-1" id="email-error" style="display: none;"></div>
                @error('email')
  ...
  <script>
    $(document).ready(function() {
        ...
        $('#forgot-password-form').on('submit', function(e) {
            ...
            // AJAX request to validate email and send reset link
            $.ajax({
                url: "{{ route('send_password_link') }}",
                type: "POST",
                data: {
                    email: email,
                ...
                error: function(xhr, status, error) {
                    ...
                    // For now, let's show a success message even on error
